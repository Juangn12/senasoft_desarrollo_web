<div>
        <div class="grid grid-cols-2 gap-6">
            ...
            <div class="grid grid-rows-2 gap-6">
                <div>
                    ...
                    <x-input class="block mt-1 w-full" type="file" name="photo" id="photo" value="{{ old('photo', $card->photo) }}" {{ $exigencia }}></x-input>
                </div>
                <div>
        ...
        <div class="flex items-center justify-end mt-4">
            <a class="underline text-sm text-gray-600 hover:text-gray-900" href="{{ route('cards.index') }}">
                {{ __('Cancelar') }}
            </a>
            <x-button class="ml-3">
                {{ $btnText }}
